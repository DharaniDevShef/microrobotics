...
| [`helper_scripts/mjcf_generator_padded.py`](helper_scripts/mjcf_generator_padded.py) | Fixed-capacity ("padded") MJCF generator for GPU-batched parallel simulation. |
| [`helper_scripts/xml_generator.py`](helper_scripts/xml_generator.py) | Generic MuJoCo assembly builder for foldable-module graphs. |
...
| [`doc/`](doc) | Design notes (module/magnet specs, simulation physics reasoning). |
...
- [`doc/design_info.txt`](doc/design_info.txt), [`doc/group_pos_info.txt`](doc/group_pos_info.txt) — physical module/magnet specifications
- [`doc/water_and_glass_physics.md`](doc/water_and_glass_physics.md) — reasoning behind the MuJoCo fluid/contact simulation parameters
