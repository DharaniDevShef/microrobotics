...
The reported simulation runs used a population of 30 and five generations. Each locomotion rollout was configured for seven seconds. The magnetic-field sweep used 0.001, 0.008 and 0.05 T, and the fresh-run random seed was 42. The comparison figures therefore describe a short preliminary study rather than a full convergence study. Only one seed is documented in the available run configuration, so variation between independent runs has not yet been measured.
